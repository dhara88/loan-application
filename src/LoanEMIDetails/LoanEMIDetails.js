      ...
      <div>
        <div class="emi-details">
          ...
          <p>
            ...
            <span>${this._data?this._data.interestRate:''} %</span>
          </p>
          <p>
            ${localize.msg('change-language:mnthlyEmi')} :
            <span>${this._data?this._data.monthlyEMI:''}</span>
          </p>
          <p>
            ${localize.msg('change-language:pricipal')} :
            <span>${this._data?this._data.principal:''}</span>
          </p>
          <p>
            ${localize.msg('change-language:interest')} :
            <span>${this._data?this._data.interest:''}</span>
          </p>
          <p>
            ${localize.msg('change-language:TotalAmt')} :
            <span>${this._data?this._data.totalAmount:''}</span>
          </p>
        </div>
        <div class="btn-cont">
